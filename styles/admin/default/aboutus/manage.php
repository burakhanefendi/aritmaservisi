    ...
    <div class="panel-body">
        ...
        <form role="form" class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label class="col-sm-2 control-label" for="field-1">About Us Content </label>

                <div class="compose-message-editor col-sm-10">
                    <textarea class="form-control" name="about" id="editor1"><?php echo set_value('about', $item->about) ?></textarea>
                </div>
            </div>
