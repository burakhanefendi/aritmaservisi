...
<div class="panel panel-default">
    <div class="panel-heading">
        ...
        <div class="panel-options">
            <a href="<?php echo site_url('admin/projects/manage'); ?>" class="btn btn-secondary btn-sm" style="color:#fff"><i class="fa fa-plus-square" aria-hidden="true"></i> Add</a>
        </div>
    </div>
                    ...
                    <?php foreach ($items as $item): ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="<?php echo site_url('admin/projects/delete/' . $item->project_id); ?>" class="btn btn-danger btn-sm">
