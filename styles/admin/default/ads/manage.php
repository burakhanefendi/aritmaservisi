    ...
    <div class="panel-body">
        ...
        <form role="form" class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10 ">
                    <input type="radio" name="type" class="show-option-type-image" value="image"> Image
                    <div class="row">
                        <div class="form-group banner-option-image">
                            <label class="col-sm-2 control-label" for="field-1">Image URL</label>

                            <div class="col-sm-10">
                                <input class="form-control" type="text" name="link" placeholder="Image URL"
                                       value="<?php echo set_value('link', $item->link) ?>">
                            </div>
                        </div>
                        <div class="form-group banner-option-image">
                            <label class="col-sm-2 control-label" for="field-1">Upload Image</label>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10 ">
                    <input type="radio" name="type" class="show-option-type-code" value="code"> Code
                    <div class="form-group banner-option-code">

                        <div class="col-sm-12">
                            <textarea class="form-control" name="code" placeholder="Text Code"
